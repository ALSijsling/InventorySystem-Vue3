...
<template>
    <table>
        ...
        <tbody>
            <tr v-for="product in products" :key="product.id">
                ...
                <TableData><router-link :to="{name: 'Edit', params:{id: product.id}}" class="m-6 px-2 py-1 bg-emerald-600 text-slate-100 rounded-lg">Edit</router-link></TableData>
            </tr>
        </tbody>
    </table>
    ...
    <div class="space-x-36">
        ...
        <button @click="router.push('Order')" class="m-6 px-4 py-2 bg-rose-600 text-slate-100 rounded-lg">Order Products</button>
    </div>
</template>